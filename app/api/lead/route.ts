  ...
  try {
    const created = await prisma.lead.create({
      data: {
        ...
        gclid: values.click?.gclid,
        gbraid: values.click?.gbraid,
        wbraid: values.click?.wbraid,
        gadSource: values.click?.gadSource,
        gadCampaignId: values.click?.gadCampaignId,
        fbclid: values.click?.fbclid,
        fbp: values.click?.fbp,
        fbc: values.click?.fbc,
